...
using Microsoft.IdentityModel.Tokens; // Need System.IdentityModel.Tokens.Jwt or Microsoft.IdentityModel.Tokens
...
public class JwksService : IJwksService
{
    ...
    private SigningKey GenerateNewRsaKey()
    {
        ...
        // Export parameters
        var privateKeyParams = rsa.ExportParameters(includePrivateParameters: true);
        var publicKeyParams = rsa.ExportParameters(includePrivateParameters: false);
        ...
        return SigningKey.Create(
            keyId: keyId,
            publicKey: publicKeyJson, // JWK format
            privateKey: privateKeyJson, // RSAParameters JSON
            algorithm: "RS256",
            isActive: true
        );
    }
