...
public class AuthorizationRepository : IAuthorizationRepository
{
    ...
    public async Task<Authorization?> GetValidAsync(long applicationId, long userId, string scopes, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<IEnumerable<Authorization>> FindAsync(Expression<Func<Authorization, bool>> predicate, CancellationToken cancellationToken = default)
    {
